...
def generate_report():
    ...
    review_llm_facing = llm_facing[:20]
    review_fallback = fallback[:10]
    ...
    report_path = os.path.join(output_dir, "reports", "phase6_llm_facing_pilot_manual_review.corrected.md")
