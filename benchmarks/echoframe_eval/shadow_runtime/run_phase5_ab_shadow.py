...
os.environ['MNEMOS_ECHOFRAME_SHADOW_SAMPLE_RATE'] = '0.10'
...
def run_soak():
    print("Initializing MNEMOS Runtime for Phase 5 A/B Shadow Review...")
    rt = MnemosRuntime()
    rt.initialize()
    ...
    for s_idx in range(sessions):
        session_id = f"AB_SHADOW_{uuid.uuid4().hex[:8]}"
