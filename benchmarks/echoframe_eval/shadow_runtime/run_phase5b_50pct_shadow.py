...
os.environ['MNEMOS_ECHOFRAME_SHADOW_SAMPLE_RATE'] = '0.50'
...
def run_soak():
    print("Initializing MNEMOS Runtime for Phase 5B 50% Shadow Review...")
    rt = MnemosRuntime()
    rt.initialize()
    ...
    for s_idx in range(sessions):
        session_id = f"PHASE5B_{uuid.uuid4().hex[:8]}"
