...
def summarize():
    ...
    with open(os.path.join(res_dir, "phase7_default_on_metrics.json"), 'w', encoding='utf-8') as f:
        json.dump(metrics, f, indent=2)
        
    md = [
        "# EchoFrame Phase 7 Default-On Eligible Traffic Summary",
    ...
    if passed:
        md.append("**PROMOTE TO DEFAULT-ON ELIGIBLE RELEASE CANDIDATE**")
        ...
        md.append("**CONTINUE DEFAULT-ON ELIGIBLE VALIDATION**")
        md.append("Safety passes but sample volume or answer-quality evidence is insufficient.")
    else:
        md.append("**ROLL BACK TO 100% ELIGIBLE PILOT**")
