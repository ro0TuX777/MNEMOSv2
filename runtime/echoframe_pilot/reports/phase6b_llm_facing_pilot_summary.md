...
- **Configured Sample Rate**: 0.25
- **Events Excluded By Sample Rate**: 1501
- **Eligible Pilot Events**: 1980
- **Events Excluded By Admission Gate**: 20
- **Selected EchoFrame LLM-Facing Events**: 494
- **Actual LLM-Facing Rate (vs Total)**: 0.2470
- **Actual LLM-Facing Rate (vs Eligible)**: 0.2495
- **Pilot Selection Rate**: 0.25
- **Baseline Fallback Events**: 1506
- **Failure Rate**: 0.00%
...
**PROMOTE TO 50% LLM-FACING PILOT**
